...
import (
	...
	"github.com/hurtki/github-banners/api/internal/infrastructure/kafka/dto"
...
func (p *BannerProducer) Publish (ctx context.Context, info renderer.GithubUserBannerInfo) error {
	event := dto.GithubBannerInfoEvent{
